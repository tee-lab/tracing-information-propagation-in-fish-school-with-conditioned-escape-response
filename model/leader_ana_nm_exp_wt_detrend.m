...
all_mat_files = struct2table(all_mat_files);

for fl = 1:height(all_mat_files)
    
    % identifying leadership 

    fname = all_mat_files.name{fl};
...
end_statement = sprintf("Constructed interaction network using naive correlation method. \n Last file number is %i. \n Time take is %f", fl, toc);
writelines(end_statement, 'end_statement_stat.txt')
