function f_wall = rep_wall_force(pos_t_1, phi_t_1, i, box_len, mini_box_len, ...
...
% disp(t)
if t < t_atk(i) % before perturbation
    ...
    if min_dist_wall > l_wall
        ...
        if min_dist_wall_id == 1 && e_i(1) < 0
            ...
            f_wall = g_wall*exp(-(min_dist_wall/l_wall))*(e_d - e_i);
...
elseif t >= t_atk(i) && pos_t_1(i,1) < box_len - mini_box_len % start of perturbation
...
elseif t > t_atk(i) && pos_t_1(i,1) > box_len - mini_box_len  % relax
